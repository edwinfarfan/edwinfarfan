...
import pe.com.cd.config.audit.AuditEventConverter;
import pe.com.cd.domain.PersistentAuditEvent;
...
import static pe.com.cd.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
